  ...
  module V4
    class CardGrantsController < ApplicationController
      ...
      def create
        ...
        @card_grant = @event.card_grants.build(params.permit(:amount_cents, :email, :merchant_lock, :category_lock, :keyword_lock, :purpose, :one_time_use).merge(sent_by: current_user))
