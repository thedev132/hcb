...
class OrganizerPositionDeletionRequestsController < ApplicationController
  ...
  def filtered_params
    params.require(:organizer_position_deletion_request).permit(:organizer_position_id, :reason, :subject_has_outstanding_expenses_expensify, :subject_emails_should_be_forwarded)
  end
