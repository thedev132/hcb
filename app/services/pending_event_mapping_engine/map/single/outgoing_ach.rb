    ...
    module Single
      class OutgoingAch
        ...
        def run
          ...
          return unless @canonical_pending_transaction.raw_pending_outgoing_ach_transaction.likely_event_id

          attrs = {
            event_id: @canonical_pending_transaction.raw_pending_outgoing_ach_transaction.likely_event_id,
