    ...
    module Single
      class Donation
        ...
        def run
          ...
          return unless @canonical_pending_transaction.raw_pending_donation_transaction.likely_event_id

          attrs = {
            event_id: @canonical_pending_transaction.raw_pending_donation_transaction.likely_event_id,
