  ...
  module SyncCommentsToHcbCodes
    class Nightly
      def run
        ...
        Comment.where(commentable_type: "Donation").find_each(batch_size: 100) do |comment|
          next unless comment.commentable
        ...
        Comment.where(commentable_type: "Disbursement").find_each(batch_size: 100) do |comment|
          next unless comment.commentable
        ...
        Comment.where(commentable_type: "Check").find_each(batch_size: 100) do |comment|
          next unless comment.commentable
