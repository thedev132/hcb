...
module LoginsHelper
  HACKATHONS = [
    ...
    {
      name: "Counterspell Ottawa",
      time: "Fall 2024",
      slug: "counterspell-ottawa",
      background: "linear-gradient(180deg, rgb(0 0 0 / 30%) 0%, rgba(0 0 0 / 50%) 100%), url('https://cloud-cuely0z02-hack-club-bot.vercel.app/10batch1photos-3112__1_.jpg')"
    }
  ].map do |hackathon|
