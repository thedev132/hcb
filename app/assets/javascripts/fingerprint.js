...
(async () => {
  ...
  document.querySelector('#device_info').value = uaParserResult.browser.name + " " + uaParserResult.browser.version
  document.querySelector('#os_info').value = uaParserResult.os.name + " " + uaParserResult.os.version
