...
class CanonicalTransaction < ApplicationRecord
  ...
  scope :likely_increase_account_number, -> { joins(hashed_transactions: :raw_increase_transaction).where(raw_increase_transaction: { increase_route_type: "account_number" }) }
